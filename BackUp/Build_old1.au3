...
FileDelete("CAB.7z")
FileDelete("D:\XPtsp\Misc\SVCPACK\DriveSp*.exe")
FileCopy($FILE & "_Silent.exe", "D:\XPtsp\Misc\SVCPACK\DriveSpc.exe", 1)

; Build the Add-On:
;=============================================================================
FileDelete("AddOn\SVCPACK\DriveSpace.exe")
FileCopy($FILE & "_Silent.exe", "AddOn\SVCPACK\DriveSpace.exe", 1)
