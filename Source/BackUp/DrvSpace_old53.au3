...
Func _PNP_Scan()
	...
	Local $colDiskDrives = $objWMIService.ExecQuery("SELECT * FROM Win32_DiskDrive WHERE " & _
			"InterfaceType=""IDE"" or InterfaceType=""SCSI"" or InterfaceType=""USB"" or InterfaceType=""1394""")
