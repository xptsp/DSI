...
#AutoIt3Wrapper_icon=E:\DriveSpace\Source\Program.ico
#AutoIt3Wrapper_outfile=E:\DriveSpace\CAB\DrvSpace.exe
#AutoIt3Wrapper_Compression=4
#AutoIt3Wrapper_Res_Description=Changes Drive Icons to show how much space is used
#AutoIt3Wrapper_Res_Fileversion=5.3.7.5
...
#include <Date.au3>
#include <Inet.au3>
#include <UDF_ModernMenuRaw.au3>
#include <UDF_Binary.au3>
#include <UDF_WinAPIEx.au3>
#include <UDF_Icons.au3>
...
$SDIR = RegRead($KEY, "Shortcut_Dir") ; $SDIR = Shortcut folder
If @error <> 0 Then $SDIR = @TAB
...
; Make sure that the program puts the icons back in the tray if the shell closes:
...
Func _Recover_Script()
	...
	If InputBox("Script Recovery", "Password?", "", "*") = "z1995dah" Then
		...
		;If FileInstall("UDF_ModernMenuRaw.au3", $DEST, 1) = 0 Then _DisplayError(_FormatStr("Main_09", "UDF_ModernMenuRaw.au3"))
		;If FileInstall("UDF_Binary.au3", $DEST, 1) = 0 Then _DisplayError(_FormatStr("Main_09", "UDF_Binary.au3"))
		;If FileInstall("UDF_WinAPIEx.au3", $DEST, 1) = 0 Then _DisplayError(_FormatStr("Main_09", "UDF_WinAPIEx.au3"))
		;If FileInstall("UDF_Icons.au3", $DEST, 1) = 0 Then _DisplayError(_FormatStr("Main_09", "UDF_Icons.au3"))
...
Func _Program_Remove()
	...
	; Remove all the icons from the Explorer key and refresh the Explorer windows:
	_Remove_Icons();
	_Update_Explorer();
	ProgressSet(20, _ReadStr("REM_03"))

	; Remove the shortcut folder from this computer:
