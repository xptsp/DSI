...
#AutoIt3Wrapper_Res_Fileversion=5.3.7.4
...
Dim $PAUSED = False, $ProgTray_BUILT = 0, $DWAR = "", $DRV_SEL = "", $MONITOR, $DIAG = "", $Timer[5], $CONFIG = 2
...
Func _Program_Remove()
	...
	ProgressSet(50, _ReadStr("REM_03"))
	$SDIR = RegRead("HKLM" & $PROC & "\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\DriveSpace", "Shortcut")
	...
	RegDelete($RUNKEY, "DriveSpace")
	RegDelete($KEY)
	ProgressSet(75, _ReadStr("REM_04"))
